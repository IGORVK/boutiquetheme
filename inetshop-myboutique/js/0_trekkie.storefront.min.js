...
main:"analytics.js",dependencies:{},devDependencies:{}}},{}],3:[function(c,g,f){g.exports={"google-analytics":c("analytics.js-integration-google-analytics"),trekkie:c("../trekkie/integration/trekkie.js"),"reports-tracking":c("../trekkie/integration/reports-tracking.js"),performance:c("../trekkie/integration/performance.js"),"facebook-pixel":c("analytics.js-integration-facebook-pixel"),pinterest:c("../trekkie/integration/pinterest.js")}},{"analytics.js-integration-google-analytics":79,"../trekkie/integration/trekkie.js":80,
"../trekkie/integration/reports-tracking.js":81,"../trekkie/integration/performance.js":82,"analytics.js-integration-facebook-pixel":83,"../trekkie/integration/pinterest.js":84}],79:[function(c,g,f){function a(a,b){if(a){var d=a.path;b.includeSearch&&a.search&&(d+=a.search);return d}}function b(a){return!a||0>a?0:Math.round(a)}function e(a,b){var d={};r([b.metrics,b.dimensions,b.contentGroupings],function(b){r(b,function(b,e){var c=v(a,b)||a[b];t.boolean(c)&&(c=c.toString());c&&(d[e]=c)})});return d}
function d(a){var b=a.properties(),b={id:a.sku()||a.id(),name:a.name(),category:a.category(),quantity:a.quantity(),price:a.price(),brand:b.brand,variant:b.variant,currency:a.currency()};if(a=a.proxy("properties.coupon"))b.coupon=a;window.ga("ec:addProduct",b)}function h(a,b,e){d(a);window.ga("ec:setAction",b,e||{})}function k(a){a=z([a.paymentMethod,a.shippingMethod],function(a){return a});return 0<a.length?a.join(", "):null}function m(a,b){b.currency=b.currency||a.currency();return new l({properties:b})}
var l=c("facade").Track,q=c("defaults"),v=c("obj-case"),r=c("each"),u=c("analytics.js-integration"),t=c("is"),p=c("object").length,w=c("global-queue")("_gaq"),z=c("select"),x=c("use-https"),A;g.exports=f=function(a){a.addIntegration(n);A=a.user()};var n=f.Integration=u("Google Analytics").readyOnLoad().global("ga").global("gaplugins").global("_gaq").global("GoogleAnalyticsObject").option("anonymizeIp",!1).option("classic",!1).option("contentGroupings",{}).option("dimensions",{}).option("domain","auto").option("doubleClick",
...
window.ga.q||[];window.ga.q.push(arguments)};window.ga.l=(new Date).getTime();"localhost"===window.location.hostname&&(a.domain="none");window.ga("create",a.trackingId,{cookieDomain:a.domain||n.prototype.defaults.domain,siteSpeedSampleRate:a.siteSpeedSampleRate,sampleRate:a.sampleRate,allowLinker:!0});a.doubleClick&&window.ga("require","displayfeatures");a.enhancedLinkAttribution&&window.ga("require","linkid","linkid.js");a.sendUserId&&A.id()&&window.ga("set","userId",A.id());a.anonymizeIp&&window.ga("set",
"anonymizeIp",!0);a=e(A.traits(),a);p(a)&&window.ga("set",a);this.load("library",this.ready)};n.prototype.loaded=function(){return!!window.gaplugins};n.prototype.page=function(b){var d=b.category(),c=b.properties(),f=b.fullName(),h=this.options,g=b.proxy("context.campaign")||{},k={},l=a(c,this.options),m=f||c.title,q=b.referrer()||"";this._category=d;k.page=l;k.title=m;k.location=c.url;g.name&&(k.campaignName=g.name);g.source&&(k.campaignSource=g.source);g.medium&&(k.campaignMedium=g.medium);g.content&&
(k.campaignContent=g.content);g.term&&(k.campaignKeyword=g.term);c=e(c,h);p(c)&&window.ga("set",c);l={page:l,title:m};q!==document.referrer&&(l.referrer=q);window.ga("set",l);this.pageCalled&&delete k.location;window.ga("send","pageview",k);d&&this.options.trackCategorizedPages&&(d=b.track(d),this.track(d,{nonInteraction:1}));f&&this.options.trackNamedPages&&(d=b.track(f),this.track(d,{nonInteraction:1}));this.pageCalled=!0};n.prototype.identify=function(a){var b=this.options;b.sendUserId&&a.userId()&&
window.ga("set","userId",a.userId());a=e(A.traits(),b);p(a)&&window.ga("set",a)};n.prototype.track=function(a,d){var c=a.options(this.name),f=this.options,h=q(d||{},c),h=q(h,f),g=a.properties(),c=a.proxy("context.campaign")||{},f=e(g,f);p(f)&&window.ga("set",f);f={eventAction:a.event(),eventCategory:a.category()||this._category||"All",eventLabel:g.label,eventValue:b(g.value||a.revenue()),nonInteraction:!(!g.nonInteraction&&!h.nonInteraction)};c.name&&(f.campaignName=c.name);c.source&&(f.campaignSource=
c.source);c.medium&&(f.campaignMedium=c.medium);c.content&&(f.campaignContent=c.content);c.term&&(f.campaignKeyword=c.term);window.ga("send","event",f)};n.prototype.completedOrder=function(a){var b=a.total()||a.revenue()||0,d=a.orderId(),e=a.products(),c=a.properties();d&&(this.ecommerce||(window.ga("require","ecommerce"),this.ecommerce=!0),window.ga("ecommerce:addTransaction",{affiliation:c.affiliation,shipping:a.shipping(),revenue:b,tax:a.tax(),id:d,currency:a.currency()}),r(e,function(b){b=m(a,
b);window.ga("ecommerce:addItem",{category:b.category(),quantity:b.quantity(),price:b.price(),name:b.name(),sku:b.sku()||b.id(),id:d,currency:b.currency()})}),window.ga("ecommerce:send"))};n.prototype.initializeClassic=function(){var a=this.options,b=a.anonymizeIp,d=a.domain,e=a.enhancedLinkAttribution,c=a.ignoredReferrers,f=a.siteSpeedSampleRate;window._gaq=window._gaq||[];w("_setAccount",a.trackingId);w("_setAllowLinker",!0);b&&w("_gat._anonymizeIp");d&&w("_setDomainName",d);f&&w("_setSiteSpeedSampleRate",
f);e&&w("_require","inpage_linkid",("https:"===document.location.protocol?"https:":"http:")+"//www.google-analytics.com/plugins/ga/inpage_linkid.js");c&&(t.array(c)||(c=[c]),r(c,function(a){w("_addIgnoredRef",a)}));this.options.doubleClick?this.load("double click",this.ready):(a=x()?"https":"http",this.load(a,this.ready))};n.prototype.loadedClassic=function(){return!(!window._gaq||window._gaq.push===Array.prototype.push)};n.prototype.pageClassic=function(b){var d=b.category(),e=b.properties(),c=b.fullName();
w("_trackPageview",a(e,this.options));d&&this.options.trackCategorizedPages&&(d=b.track(d),this.track(d,{nonInteraction:1}));c&&this.options.trackNamedPages&&(d=b.track(c),this.track(d,{nonInteraction:1}))};n.prototype.trackClassic=function(a,d){var e=d||a.options(this.name),c=a.properties(),f=a.revenue(),h=a.event(),g=this._category||a.category()||"All",k=c.label,f=b(f||c.value);w("_trackEvent",g,h,k,f,!(!c.nonInteraction&&!e.nonInteraction))};n.prototype.completedOrderClassic=function(a){var b=
a.total()||a.revenue()||0,d=a.orderId(),e=a.products()||[],c=a.properties(),f=a.currency();d&&(w("_addTrans",d,c.affiliation,b,a.tax(),a.shipping(),a.city(),a.state(),a.country()),r(e,function(a){a=new l({properties:a});w("_addItem",d,a.sku()||a.id(),a.name(),a.category(),a.price(),a.quantity())}),w("_set","currencyCode",f),w("_trackTrans"))};n.prototype.loadEnhancedEcommerce=function(a){this.enhancedEcommerceLoaded||(window.ga("require","ec"),this.enhancedEcommerceLoaded=!0);window.ga("set","&cu",
a.currency())};n.prototype.pushEnhancedEcommerce=function(a){a=z(["send","event",a.category()||"EnhancedEcommerce",a.event()||"Action not defined",a.properties().label,{nonInteraction:1}],function(a){return void 0!==a});window.ga.apply(window,a)};n.prototype.startedOrderEnhanced=function(a){this.viewedCheckoutStep(a)};n.prototype.updatedOrderEnhanced=function(a){this.startedOrderEnhanced(a)};n.prototype.viewedCheckoutStepEnhanced=function(a){var b=a.products(),e=a.properties(),c=k(e);this.loadEnhancedEcommerce(a);
r(b,function(b){b=m(a,b);d(b)});window.ga("ec:setAction","checkout",{step:e.step||1,option:c||void 0});this.pushEnhancedEcommerce(a)};n.prototype.completedCheckoutStepEnhanced=function(a){var b=a.properties(),d=k(b);b.step&&d&&(this.loadEnhancedEcommerce(a),window.ga("ec:setAction","checkout_option",{step:b.step||1,option:d}),window.ga("send","event","Checkout","Option"))};n.prototype.completedOrderEnhanced=function(a){var b=a.total()||a.revenue()||0,e=a.orderId(),c=a.products(),f=a.properties();
e&&(this.loadEnhancedEcommerce(a),r(c,function(b){b=m(a,b);d(b)}),window.ga("ec:setAction","purchase",{id:e,affiliation:f.affiliation,revenue:b,tax:a.tax(),shipping:a.shipping(),coupon:a.coupon()}),this.pushEnhancedEcommerce(a))};n.prototype.refundedOrderEnhanced=function(a){var b=a.orderId(),d=a.products();b&&(this.loadEnhancedEcommerce(a),r(d,function(a){a=new l({properties:a});window.ga("ec:addProduct",{id:a.sku()||a.id(),quantity:a.quantity()})}),window.ga("ec:setAction","refund",{id:b}),this.pushEnhancedEcommerce(a))};
n.prototype.addedProductEnhanced=function(a){this.loadEnhancedEcommerce(a);h(a,"add");this.pushEnhancedEcommerce(a)};n.prototype.removedProductEnhanced=function(a){this.loadEnhancedEcommerce(a);h(a,"remove");this.pushEnhancedEcommerce(a)};n.prototype.viewedProductEnhanced=function(a){var b=a.properties(),d={};this.loadEnhancedEcommerce(a);b.list&&(d.list=b.list);h(a,"detail",d);this.pushEnhancedEcommerce(a)};n.prototype.clickedProductEnhanced=function(a){var b=a.properties(),d={};this.loadEnhancedEcommerce(a);
b.list&&(d.list=b.list);h(a,"click",d);this.pushEnhancedEcommerce(a)};n.prototype.viewedPromotionEnhanced=function(a){var b=a.properties();this.loadEnhancedEcommerce(a);window.ga("ec:addPromo",{id:a.id(),name:a.name(),creative:b.creative,position:b.position});this.pushEnhancedEcommerce(a)};n.prototype.clickedPromotionEnhanced=function(a){var b=a.properties();this.loadEnhancedEcommerce(a);window.ga("ec:addPromo",{id:a.id(),name:a.name(),creative:b.creative,position:b.position});window.ga("ec:setAction",
"promo_click",{});this.pushEnhancedEcommerce(a)}},{facade:8,defaults:85,"obj-case":42,each:4,"analytics.js-integration":86,is:18,object:20,"global-queue":87,select:88,"use-https":89}],85:[function(c,g,f){g.exports=function(a,b){for(var e in b)e in a||(a[e]=b[e]);return a}},{}],86:[function(c,g,f){var a=c("bind"),b=c("clone"),e=c("debug"),d=c("defaults"),h=c("extend"),k=c("slug"),m=c("./protos"),l=c("./statics");g.exports=function(c){function f(h){if(h&&h.addIntegration)return h.addIntegration(f);
this.debug=e("analytics:integration:"+k(c));this.options=d(b(h)||{},this.defaults);this._queue=[];this.once("ready",a(this,this.flush));f.emit("construct",this);this.ready=a(this,this.ready);this._wrapInitialize();this._wrapPage();this._wrapTrack()}f.prototype.defaults={};f.prototype.globals=[];f.prototype.templates={};f.prototype.name=c;h(f,l);h(f.prototype,m);return f}},{bind:55,clone:12,debug:90,defaults:15,extend:91,slug:92,"./protos":93,"./statics":94}],90:[function(c,g,f){g.exports="undefined"==
typeof window?c("./lib/debug"):c("./debug")},{"./lib/debug":95,"./debug":96}],95:[function(c,g,f){c=c("tty");g.exports=function(c){function f(){}function g(a){a=a instanceof Error?a.stack||a.message:a;var b=new Date,e=b-(d[c]||b);d[c]=b;b="  \u001b[9"+u+"m"+c+" \u001b[3"+u+"m\u001b[90m"+a+"\u001b[3"+u+"m +";e=36E5<=e?(e/36E5).toFixed(1)+"h":6E4<=e?(e/6E4).toFixed(1)+"m":1E3<=e?(e/1E3|0)+"s":e+"ms";a=b+e+"\u001b[0m";console.error.apply(this,arguments)}function v(a){a=a instanceof Error?a.stack||a.message:
a;a=(new Date).toUTCString()+" "+c+" "+a;console.error.apply(this,arguments)}f.enabled=!1;var r=b.some(function(a){return a.test(c)});if(r)return f;r=a.some(function(a){return a.test(c)});if(!r)return f;var u=e[h++%e.length];g.enabled=v.enabled=!0;return k||process.env.DEBUG_COLORS?g:v};var a=[],b=[];(process.env.DEBUG||"").split(/[\s,]+/).forEach(function(d){d=d.replace("*",".*?");"-"===d[0]?b.push(new RegExp("^"+d.substr(1)+"$")):a.push(new RegExp("^"+d+"$"))});var e=[6,2,3,4,5,1],d={},h=0,k=c.isatty(2)},
{}],96:[function(c,g,f){function a(b){return a.enabled(b)?function(e){e instanceof Error&&(e=e.stack||e.message);var d=new Date,c=d-(a[b]||d);a[b]=d;e=b+" "+e+" +"+a.humanize(c);window.console&&console.log&&Function.prototype.apply.call(console.log,console,arguments)}:function(){}}g.exports=a;a.names=[];a.skips=[];a.enable=function(b){try{localStorage.debug=b}catch(c){}for(var e=(b||"").split(/[\s,]+/),d=e.length,f=0;f<d;f++)b=e[f].replace("*",".*?"),"-"===b[0]?a.skips.push(new RegExp("^"+b.substr(1)+
"$")):a.names.push(new RegExp("^"+b+"$"))};a.disable=function(){a.enable("")};a.humanize=function(a){return 36E5<=a?(a/36E5).toFixed(1)+"h":6E4<=a?(a/6E4).toFixed(1)+"m":1E3<=a?(a/1E3|0)+"s":a+"ms"};a.enabled=function(b){for(var e=0,d=a.skips.length;e<d;e++)if(a.skips[e].test(b))return!1;e=0;for(d=a.names.length;e<d;e++)if(a.names[e].test(b))return!0;return!1};try{window.localStorage&&a.enable(localStorage.debug)}catch(b){}},{}],91:[function(c,g,f){g.exports=function(a){for(var b=Array.prototype.slice.call(arguments,
1),e=0,d;d=b[e];e++)if(d)for(var c in d)a[c]=d[c];return a}},{}],92:[function(c,g,f){g.exports=function(a,b){b||(b={});return a.toLowerCase().replace(b.replace||/[^a-z0-9]/g," ").replace(/^ +| +$/g,"").replace(/ +/g,b.separator||"-")}},{}],93:[function(c,g,f){function a(){}function b(a){return x.array(a)?z(e,a)?"mixed":"array":x.object(a)?"map":"unknown"}function e(a){return x.object(a)&&x.string(a.key)&&A.call(a,"value")?!0:!1}function d(a,b){b=b||function(){};var d=new Image;d.onerror=h(b,"failed to load pixel",
d);d.onload=function(){b()};d.src=a.src;d.width=1;d.height=1;return d}function h(a,b,d){return function(e){e=e||window.event;var c=Error(b);c.event=e;c.source=d;a(c)}}function k(a,b){return r(function(a,d,e){a[e]=d.replace(/\{\{\ *(\w+)\ *\}\}/g,function(a,d){return b[d]});return a},{},a.attrs)}g=c("emitter");var m=c("after"),l=c("each"),q=c("analytics-events"),v=c("fmt"),r=c("foldl"),u=c("load-iframe"),t=c("load-script"),p=c("to-no-case"),w=c("next-tick"),z=c("every"),x=c("is"),A=Object.prototype.hasOwnProperty,
n=window.onerror,B=window.setInterval,C=window.setTimeout;g(f);f.initialize=function(){w(this.ready)};f.loaded=function(){return!1};f.page=function(a){};f.track=function(a){};f.map=function(a,d){var e=p(d),c=b(a);return"unknown"===c?[]:r(function(a,b,d){var f,h;"map"===c&&(f=d,h=b);"array"===c&&(h=f=b);"mixed"===c&&(f=b.key,h=b.value);p(f)===e&&a.push(h);return a},[],a)};f.invoke=function(a){if(this[a]){var b=Array.prototype.slice.call(arguments,1);if(!this._ready)return this.queue(a,b);var d;try{this.debug("%s with %o",
...
viewedPromotion:/^[ _]?viewed[ _]?promotion?[ _]?$/i,clickedPromotion:/^[ _]?clicked[ _]?promotion?[ _]?$/i,viewedCheckoutStep:/^[ _]?viewed[ _]?checkout[ _]?step[ _]?$/i,completedCheckoutStep:/^[ _]?completed[ _]?checkout[ _]?step[ _]?$/i}},{}],99:[function(c,g,f){function a(b){var e=[].slice.call(arguments,1),d=0;return b.replace(/%([a-z])/gi,function(b,c){return a[c]?a[c](e[d++]):b+c})}c=window.JSON?JSON.stringify:function(a){return String(a)};g.exports=a;a.o=c;a.s=String;a.d=parseInt},{}],100:[function(c,
...
a(g,c);b(function(){var a=document.getElementsByTagName("script")[0];a.parentNode.insertBefore(g,a)});return g}},{"script-onload":106,"next-tick":56,type:47}],106:[function(c,g,f){function a(a,b){a.addEventListener("load",function(a,c){b(null,c)},!1);a.addEventListener("error",function(c){var f=Error('script error "'+a.src+'"');f.event=c;b(f)},!1)}function b(a,b){a.attachEvent("onreadystatechange",function(c){/complete|loaded/.test(a.readyState)&&b(null,c)});a.attachEvent("onerror",function(c){var f=
Error('failed to load the script "'+a.src+'"');f.event=c||window.event;b(f)})}g.exports=function(c,d){return c.addEventListener?a(c,d):b(c,d)}},{}],101:[function(c,g,f){var a=c("script-onload"),b=c("next-tick"),e=c("type");g.exports=function(d,c){if(!d)throw Error("Cant load nothing...");"string"==e(d)&&(d={src:d});var f="https:"===document.location.protocol||"chrome-extension:"===document.location.protocol;d.src&&0===d.src.indexOf("//")&&(d.src=f?"https:"+d.src:"http:"+d.src);f&&d.https?d.src=d.https:
!f&&d.http&&(d.src=d.http);var g=document.createElement("script");g.type="text/javascript";g.async=!0;g.src=d.src;"function"==e(c)&&a(g,c);b(function(){var a=document.getElementsByTagName("script")[0];a.parentNode.insertBefore(g,a)});return g}},{"script-onload":106,"next-tick":56,type:47}],102:[function(c,g,f){function a(a){return a.replace(h,function(a,b){return b?" "+b:""})}function b(a){return a.replace(k,function(a,b,d){return b+" "+d.toLowerCase().split("").join(" ")})}g.exports=function(c){return e.test(c)?
c.toLowerCase():d.test(c)?a(c).toLowerCase():b(c).toLowerCase()};var e=/\s/,d=/[\W_]/,h=/[\W_]+(.|$)/g,k=/(.)([A-Z]+)/g},{}],103:[function(c,g,f){var a;try{a=c("@ndhoule/each")}catch(b){a=c("each")}g.exports=function(b,c){if("function"!==typeof b)throw new TypeError("`predicate` must be a function but was a "+typeof b);var d=!0;a(function(a,c,e){d=!!b(a,c,e);if(!d)return!1},c);return d}},{each:65}],104:[function(c,g,f){function a(a){return function(d){return a===b(d)}}g=c("is-empty");try{var b=c("type")}catch(h){b=
c("component-type")}c="arguments array boolean date element function null number object regexp string undefined".split(" ");for(var e=0,d;d=c[e];e++)f[d]=a(d);f.fn=f["function"];f.empty=g;f.nan=function(a){return f.number(a)&&a!=a}},{"is-empty":46,type:47,"component-type":47}],94:[function(c,g,f){function a(a){a=a.replace(' src="',' data-src="');var c=b(a),f={};e(c.attributes,function(b){var c="data-src"===b.name?"src":b.name;d(b.name+"=",a)&&(f[c]=b.value)});return{type:c.tagName.toLowerCase(),attrs:f}}
...
b){for(var d in b)a[d]=b[d];return a},f=d({},a);return d(f,c)}},{"analytics.js-integration":86,"./../trekkie.js":108}],108:[function(c,g,f){function a(a,d){if(!a)throw"appName argument is required to initialize Trekkie.";this.appName=a;d=d?d:{};this.environment=d.environment||"production";delete d.environment;this.defaultAttributes=this._merge(d,{hasUniqCookie:b.hasUniqCookie()?1:0,hasVisitCookie:b.hasVisitCookie()?1:0,visitToken:b.visitToken(),uniqToken:b.uniqToken(),microSessionId:b.buildUniqToken(),
microSessionCount:0,firstSeen:b.firstSeen(),appName:a});this.request=e;window._visit={multitrackToken:b.uniqToken}}var b=c("./lib/token.js"),e=c("./lib/request.js"),d=c("./lib/events.js");a.prototype.emit=function(a,b){this.defaultAttributes.microSessionCount+=1;var c=this._merge(this.defaultAttributes,this._sanitize(b)),c=this._merge(c,d.additionalParamsFromEvent(b.event));if("production"===this.environment)return this.request.load(this.appName,a,c);console.log("Logging trekkie "+a+" event to "+
this.appName+" with:");console.log(c)};a.prototype._sanitize=function(a){var b={},d;for(d in a)a[d]&&(b[d]=a[d]);return b};a.prototype._merge=function(a,b){var d=function(a,b){for(var d in b)a[d]=b[d];return a},c=d({},a);return d(c,b)};g.exports=a},{"./lib/token.js":109,"./lib/request.js":110,"./lib/events.js":111}],109:[function(c,g,f){var a=c("./cookie.js"),b=c("./store.js"),e={_uniqueId:{fetch:function(d,c){var e={permanent:d},f=a.read(c),e=b.read(c,e);return f||e},fetchOrSet:function(d){var c=
d?"_y":"_s",f=d?"_shopify_y":"_shopify_s",g=e._uniqueId.fetch(d,c)||e._uniqueId.fetch(d,f)||e._uniqueId.build();d={permanent:d};a.write(c,g,d);a.write(f,g,d);b.write(c,g,d);b.write(f,g,d);return g},generateWeakUUID:function(){return"xxxxxxxx-xxxx-4xxx-xxxx".replace(/[x]/g,function(a){var b=16*Math.random()|0;return("x"===a?b:b&3|8).toString(16)}).toUpperCase()},generateStrongUUID:function(a){var b=0;return"xxxxxxxx-xxxx-4xxx-xxxx".replace(/[x]/g,function(c){var e=a[b]%16;b++;return("x"===c?e:e&3|
8).toString(16)}).toUpperCase()},build:function(){if(a.isEnabled())try{var b=window.crypto||window.msCrypto,c=new Uint16Array(19);b.getRandomValues(c);return e._uniqueId.generateStrongUUID(c)}catch(f){return e._uniqueId.generateWeakUUID()}else return"00000000-0000-0000-4000-000000000000"}},_firstSeen:{fetch:function(){var d=a.read("_shopify_fs"),c=b.read("_shopify_fs",{permanent:!0});return d||c},fetchOrSet:function(){var d=e._firstSeen.fetch()||(new Date).toISOString(),c={permanent:!0};a.write("_shopify_fs",
d,c);b.write("_shopify_fs",d,c);return d}},hasShortTerm:function(){return!!a.read("_shopify_s")||!!a.read("_s")},hasLongTerm:function(){return!!a.read("_shopify_y")||!!a.read("_y")},shortTerm:function(){return e._uniqueId.fetchOrSet(!1)},longTerm:function(){return e._uniqueId.fetchOrSet(!0)},hasFirstSeen:function(){return!!a.read("_shopify_fs")},firstSeen:function(){return e._firstSeen.fetchOrSet()}};f.visitToken=e.shortTerm;f.uniqToken=e.longTerm;f.hasUniqCookie=e.hasLongTerm;f.hasVisitCookie=e.hasShortTerm;
f.buildUniqToken=e._uniqueId.build;f.hasFirstSeen=e.hasFirstSeen;f.firstSeen=e.firstSeen},{"./cookie.js":112,"./store.js":113}],112:[function(c,g,f){var a=c("cookie"),b=c("./utils.js"),e={read:function(b){return a(b)},writeForDomain:function(b,c,f,g){f={maxage:e._maxage(f),domain:g,path:"/"};a(b,c,f)},write:function(a,b,c){e.isEnabled()&&(c=c||{},e.writeForDomain(a,b,c.permanent,e.shopifyCookieDomain(window.location.hostname)),e.writeForDomain(a,b,c.permanent,".myshopify.com"),e.writeForDomain(a,
b,c.permanent,c.domain))},_maxage:function(a){return a?62208E6:18E5},shopifyCookieDomain:function(a){var c=a.indexOf("shopify");return-1!==c?b.startsWith(a,"shopify")?"."+a:a.slice(c-1):".shopify.com"},isEnabled:function(){return window.navigator.cookieEnabled}};f.read=e.read;f.write=e.write;f.shopifyCookieDomain=e.shopifyCookieDomain;f.isEnabled=e.isEnabled},{cookie:114,"./utils.js":115}],114:[function(c,g,f){function a(){var a;try{a=document.cookie}catch(b){return"undefined"!==typeof console&&"function"===
typeof console.error&&console.error(b.stack||b),{}}var c={};a=a.split(/ *; */);var d;if(""!=a[0])for(var f=0;f<a.length;++f)d=a[f].split("="),c[e(d[0])]=e(d[1]);return c}function b(a){try{return encodeURIComponent(a)}catch(b){d("error `encode(%o)` - %o",a,b)}}function e(a){try{return decodeURIComponent(a)}catch(b){d("error `decode(%o)` - %o",a,b)}}var d=c("debug")("cookie");g.exports=function(c,d,e){switch(arguments.length){case 3:case 2:var f;f=e||{};var g=b(c)+"="+b(d);null==d&&(f.maxage=-1);f.maxage&&
(f.expires=new Date(+new Date+f.maxage));f.path&&(g+="; path="+f.path);f.domain&&(g+="; domain="+f.domain);f.expires&&(g+="; expires="+f.expires.toUTCString());f.secure&&(g+="; secure");document.cookie=g;break;case 1:return a()[c];default:return a()}}},{debug:116}],116:[function(c,g,f){function a(){var a;try{a=f.storage.debug}catch(b){}return a}f=g.exports=c("./debug");f.log=function(){return"object"===typeof console&&console.log&&Function.prototype.apply.call(console.log,console,arguments)};f.formatArgs=
function(){var a=arguments,b=this.useColors;a[0]=(b?"%c":"")+this.namespace+(b?" %c":" ")+a[0]+(b?"%c ":" ")+"+"+f.humanize(this.diff);if(!b)return a;var b="color: "+this.color,a=[a[0],b,"color: inherit"].concat(Array.prototype.slice.call(a,1)),c=0,g=0;a[0].replace(/%[a-z%]/g,function(a){"%%"!==a&&(c++,"%c"===a&&(g=c))});a.splice(g,0,b);return a};f.save=function(a){try{null==a?f.storage.removeItem("debug"):f.storage.debug=a}catch(b){}};f.load=a;f.useColors=function(){return"WebkitAppearance"in document.documentElement.style||
window.console&&(console.firebug||console.exception&&console.table)||navigator.userAgent.toLowerCase().match(/firefox\/(\d+)/)&&31<=parseInt(RegExp.$1,10)};var b;if("undefined"!=typeof chrome&&"undefined"!=typeof chrome.storage)b=chrome.storage.local;else a:{try{b=window.localStorage;break a}catch(e){}b=void 0}f.storage=b;f.colors="lightseagreen forestgreen goldenrod dodgerblue darkorchid crimson".split(" ");f.formatters.j=function(a){return JSON.stringify(a)};f.enable(a())},{"./debug":117}],117:[function(c,
g,f){f=g.exports=function(c){function d(){}function g(){var c=+new Date;g.diff=c-(b||c);g.prev=b;b=g.curr=c;null==g.useColors&&(g.useColors=f.useColors());null==g.color&&g.useColors&&(g.color=f.colors[a++%f.colors.length]);var d=Array.prototype.slice.call(arguments);d[0]=f.coerce(d[0]);"string"!==typeof d[0]&&(d=["%o"].concat(d));var e=0;d[0]=d[0].replace(/%([a-z%])/g,function(a,b){if("%%"===a)return a;e++;var c=f.formatters[b];"function"===typeof c&&(a=c.call(g,d[e]),d.splice(e,1),e--);return a});
"function"===typeof f.formatArgs&&(d=f.formatArgs.apply(g,d));(g.log||f.log||console.log.bind(console)).apply(g,d)}d.enabled=!1;g.enabled=!0;var k=f.enabled(c)?g:d;k.namespace=c;return k};f.coerce=function(a){return a instanceof Error?a.stack||a.message:a};f.disable=function(){f.enable("")};f.enable=function(a){f.save(a);for(var b=(a||"").split(/[\s,]+/),c=b.length,g=0;g<c;g++)b[g]&&(a=b[g].replace(/\*/g,".*?"),"-"===a[0]?f.skips.push(new RegExp("^"+a.substr(1)+"$")):f.names.push(new RegExp("^"+a+
"$")))};f.enabled=function(a){var b,c;b=0;for(c=f.skips.length;b<c;b++)if(f.skips[b].test(a))return!1;b=0;for(c=f.names.length;b<c;b++)if(f.names[b].test(a))return!0;return!1};f.humanize=c("ms");f.names=[];f.skips=[];f.formatters={};var a=0,b},{ms:118}],118:[function(c,g,f){function a(a){a=""+a;if(!(1E4<a.length)&&(a=/^((?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|years?|yrs?|y)?$/i.exec(a))){var b=parseFloat(a[1]);switch((a[2]||"ms").toLowerCase()){case "years":case "year":case "yrs":case "yr":case "y":return 315576E5*
b;case "days":case "day":case "d":return 864E5*b;case "hours":case "hour":case "hrs":case "hr":case "h":return 36E5*b;case "minutes":case "minute":case "mins":case "min":case "m":return 6E4*b;case "seconds":case "second":case "secs":case "sec":case "s":return 1E3*b;case "milliseconds":case "millisecond":case "msecs":case "msec":case "ms":return b}}}function b(a,b,c){if(!(a<b))return a<1.5*b?Math.floor(a/b)+" "+c:Math.ceil(a/b)+" "+c+"s"}g.exports=function(c,d){d=d||{};return"string"==typeof c?a(c):
d.long?b(c,864E5,"day")||b(c,36E5,"hour")||b(c,6E4,"minute")||b(c,1E3,"second")||c+" ms":864E5<=c?Math.round(c/864E5)+"d":36E5<=c?Math.round(c/36E5)+"h":6E4<=c?Math.round(c/6E4)+"m":1E3<=c?Math.round(c/1E3)+"s":c+"ms"}},{}],115:[function(c,g,f){f.startsWith=function(a,b){return 0===a.indexOf(b)};f.endsWith=function(a,b){var c=a.length-b.length,d=a.indexOf(b);return-1!==d&&d===c}},{}],113:[function(c,g,f){var a={_storeType:function(a){a=a||{};return a.permanent?window.localStorage:window.sessionStorage},
_isAvailable:function(a){try{a.setItem("t","t");var c=a.getItem("t");a.removeItem("t");return"t"===c}catch(d){return!1}},read:function(b,c){var d=a._storeType(c);return a._isAvailable(d)?d.getItem(b):null},write:function(b,c,d){d=a._storeType(d);return a._isAvailable(d)?d.setItem(b,c):null}};f.read=a.read;f.write=a.write},{}],110:[function(c,g,f){var a=c("load-pixel")("https://v.shopify.com/:app/:type"),b=c("querystring").parse,e={load:function(b,c,f){return a(f,{app:b,type:c},e._error)},_error:function(c){if(c&&
c.event===window.event){var e=c.source.src.split("?"),f=e[0].split(".com/")[1].split("/");c=f[0];var f=f[1],e=b(e[1]),g={};e.event&&(g.event=e.event);e.url&&(g.url=e.url);g.truncated=!0;return a(g,{app:c,type:f})}}};f.load=e.load},{"load-pixel":119,querystring:27}],119:[function(c,g,f){function a(a,b,c){return function(e){e=e||window.event;var f=Error(b);f.event=e;f.source=c;a(f)}}var b=c("querystring").stringify,e=c("substitute");g.exports=function(c){return function(f,g,m){"function"==typeof g&&
(m=g,g={});g=g||{};m=m||function(){};g=e(c,g);var l=new Image;l.onerror=a(m,"failed to load pixel",l);l.onload=function(){m()};(f=b(f))&&(f="?"+f);l.src=g+f;l.width=1;l.height=1;return l}}},{querystring:27,substitute:120}],120:[function(c,g,f){g.exports=function(b,c,d){if(!c)throw new TypeError("expected an object");d=d||/:(\w+)/g;return b.replace(d,function(b,d){switch(a.call(c)){case "[object Object]":return null!=c[d]?c[d]:b;case "[object Array]":var f=c.shift();return null!=f?f:b}})};var a=Object.prototype.toString},
{}],111:[function(c,g,f){var a={"Viewed Product":{resourceType:"product",pageType:"product"},"Added Product":{eventType:"add_to_cart",resourceType:"product",pageType:"cart"},"Removed Product":{eventType:"remove_from_cart",resourceType:"product",pageType:"cart"},"Viewed Cart":{pageType:"cart"},"Cleared Cart":{eventType:"clear_cart",pageType:"cart"},"Viewed Product Category":{resourceType:"collection",pageType:"collection"},"Viewed Collections":{pageType:"collections"}};f.additionalParamsFromEvent=
function(b){b=a[b];var c={},d;for(d in b)b.hasOwnProperty(d)&&(c[d]=b[d]);return c}},{}],81:[function(c,g,f){c=c("analytics.js-integration");g=g.exports=c("ReportsTracking").option("shopId",null).option("timezoneOffset",null).option("requestId",null).option("pageUrl",null).option("uniqId",null).option("subject",null).option("tag",null).option("customerId",null).option("page",null).option("resourceType",null).option("resourceID",null).tag('<script src="cdn.shopify.com/s/javascripts/shopify_stats.js?v=6">');
var a={shopId:"a",timezoneOffset:"offset",requestId:"reqid",pageUrl:"pageurl",uniqId:"u",subject:"s",tag:"t",customerId:"cid",page:"p",resourceType:"rtyp",resourceID:"rid"};g.prototype.initialize=function(){var b={},c;for(c in a)this.options.hasOwnProperty(c)&&this.options[c]&&(b[a[c]]=this.options[c]);window.__st=b;this.load(this.ready)};g.prototype.page=function(){}},{"analytics.js-integration":86}],82:[function(c,g,f){f=c("analytics.js-integration");var a=c("./../lib/perf.js");c=g.exports=f("Performance").option("navigationTimingApiMeasurementsEnabled",
!1).option("navigationTimingApiMeasurementsSampleRate",.5);c.prototype.initialize=function(){this.ready()};c.prototype.page=function(b){b=this._merge(b.properties(),{category:b.category(),name:b.name()});this.options.navigationTimingApiMeasurementsEnabled&&this.options.navigationTimingApiMeasurementsSampleRate>=Math.random()&&(b=this._merge(a.pagePerfomance(),b),this.analytics.track("navigation_performance_metrics",b))};c.prototype._merge=function(a,c){var d=function(a,b){for(var c in b)a[c]=b[c];
return a},f=d({},a);return d(f,c)}},{"analytics.js-integration":86,"./../lib/perf.js":121}],121:[function(c,g,f){var a="navigationStart unloadEventStart unloadEventEnd redirectStart redirectEnd fetchStart domainLookupStart domainLookupEnd connectStart connectEnd secureConnectionStart requestStart responseStart responseEnd domLoading domInteractive domContentLoadedEventStart domContentLoadedEventEnd domComplete loadEventStart loadEventEnd".split(" ");f.perfAttrs=a;f.pagePerfomance=function(){var b=
{},c=function(){for(var c=0,d=a.length;c<d;c++)b["nt:"+a[c]]=0;b["nt:valid"]=!1};if(window.performance&&window.performance.timing&&!/MSIE 9.0|Firefox\/7.0|Firefox\/8.0/.test(window.navigator.userAgent))try{for(var d=0,f=a.length;d<f;d++)b["nt:"+a[d]]=window.performance.timing[a[d]];b["nt:valid"]=!0}catch(g){c()}else c();return b}},{}],83:[function(c,g,f){function a(a){return Number(a||0).toFixed(2)}function b(a){return a.properties().productId||a.id()||a.sku()||""}function e(a){var b;return k(function(a,
c){(b=c.productId||c.id||c.sku)&&-1===a.indexOf(b)&&a.push(b);return a},[],a.products()||[])}function d(a){a=a.products()||[];for(var b=0;b<a.length;b++)if(a[b].productId)return"product_group";return"product"}function h(a){return k(function(a,b){return a+(b.quantity||0)},0,a.products()||[])}f=c("analytics.js-integration");var k=c("foldl"),m=c("each");c=g.exports=f("Facebook Pixel").global("fbq").option("pixelId","").option("pixelIds",[]).option("agent","seg").mapping("standardEvents").mapping("legacyEvents").tag('<script src="//connect.facebook.net/en_US/fbevents.js">');
...
function(){return!(!window.fbq||!window.fbq.callMethod)};c.prototype.page=function(){window.fbq("track","PageView")};c.prototype.track=function(b){var c=b.event(),d=a(b.revenue()),e=k(function(a,b,c){if("revenue"===c)return a.value=d,a;a[c]=b;return a},{},b.properties()),f=this.standardEvents(c),g=this.legacyEvents(c);[].concat(f,g).length?(m(function(a){window.fbq("track",a,e)},f),m(function(a){window.fbq("track",a,{currency:b.currency(),value:d})},g)):window.fbq("trackCustom",c,e)};c.prototype.viewedProductCategory=
function(){};c.prototype.viewedProduct=function(c){window.fbq("track","ViewContent",{content_ids:[b(c)],content_type:c.properties().productId?"product_group":"product",content_name:c.name()||"",content_category:c.category()||"",currency:c.currency(),value:a(c.price())});m(function(b){window.fbq("track",b,{currency:c.currency(),value:a(c.revenue())})},this.legacyEvents(c.event()))};c.prototype.addedProduct=function(c){window.fbq("track","AddToCart",{content_ids:[b(c)],content_type:c.properties().productId?
"product_group":"product",content_name:c.name()||"",content_category:c.category()||"",currency:c.currency(),value:a(c.price()),num_items:c.quantity()});m(function(b){window.fbq("track",b,{currency:c.currency(),value:a(c.revenue())})},this.legacyEvents(c.event()))};c.prototype.completedOrder=function(b){var c=a(b.revenue());window.fbq("track","Purchase",{content_ids:e(b),content_type:d(b),currency:b.currency(),value:c,num_items:h(b)});m(function(c){window.fbq("track",c,{currency:b.currency(),value:a(b.revenue())})},
this.legacyEvents(b.event()))};c.prototype.startedOrder=function(b){var c=a(b.revenue());window.fbq("track","InitiateCheckout",{content_ids:e(b),content_type:d(b),currency:b.currency(),value:c,num_items:h(b)});m(function(c){window.fbq("track",c,{currency:b.currency(),value:a(b.revenue())})},this.legacyEvents(b.event()))}},{"analytics.js-integration":86,foldl:16,each:65}],84:[function(c,g,f){c=c("analytics.js-integration");(g.exports=c("Pinterest Pixel").option("pixelId").tag("PinterestCompletedCheckout",
'<img height="1" width="1" style="display:none;" alt="" src="https://ct.pinterest.com/v2.5/?tid={{pixelId}}&event=checkout&value=0.00&quantity=1"/>')).prototype.completedOrder=function(){this.load("PinterestCompletedCheckout")}},{"analytics.js-integration":86}]},{},{1:"trekkie"});
